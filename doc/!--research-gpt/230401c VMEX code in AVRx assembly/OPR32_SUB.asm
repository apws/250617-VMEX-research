    ...
    sub  R16, R20         ; Subtract the first bytes
    sbc  R17, R21         ; Subtract the second bytes with borrow
    sbc  R18, R22         ; Subtract the third bytes with borrow
    sbc  R19, R23         ; Subtract the fourth bytes with borrow
